  ...
  return (
    <>
      <section ref={ref} id="contact" className="h-[calc(100vh-var(--navbar-height))] flex flex-col justify-center items-center text-center relative z-1 px-8 bg-[#0b0b0d]">
        <div className="max-w-275 mx-auto w-full flex flex-col items-center justify-center h-full">
          <motion.span
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-72px" }}
            variants={fadeUp(layer.marker)}
            className="font-mono text-[11px] text-[#525260] tracking-[0.15em] uppercase mb-6 block"
          >
            04 — Let's talk
          </motion.span>
          <motion.h2
            ...
            className="font-bebas text-[clamp(56px,10vw,120px)] text-[#f0f0f5] leading-[0.9] mb-10"
          >
            Let's<br />Build<br />
